...
const TrialCountdown = ({ startDate, lang }: { startDate: string, lang: Language }) => {
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (sessionId && user && profile && profile.subscriptionStatus !== 'active') {
    ...
    <div className="relative">
      {!user ? (
        ...
        <div className="fixed top-0 left-0 right-0 z-50 p-6 flex justify-end">
          <motion.button 
            ...
            className="flex items-center gap-3 px-5 py-2.5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full backdrop-blur-xl transition-all group"
          >
          ...
          >
            ...
            <div className="p-4 border-t border-white/10 bg-black/20 shrink-0">
              ...
              <div className="flex gap-2">
                <button 
                  onClick={toggleLanguage}
                  className="flex-1 bg-white/5 hover:bg-white/10 p-2 rounded-xl flex items-center justify-center gap-2 transition-colors text-xs"
                >
      ...
      <main className="flex-1 flex flex-col relative w-full min-w-0">
        ...
        <div className="p-3 sm:p-6 bg-gradient-to-t from-black to-transparent shrink-0">
          ...
          <p className="text-[9px] sm:text-[10px] text-center text-zinc-600 mt-3 sm:mt-4 uppercase tracking-[0.2em]">
                ...
                {legalModal === 'notice' ? (
                  <div className="space-y-6">
                    <section>
                      ...
                      <p>Le site EASA Assist est édité par la société <strong>Aviation Online</strong>.</p>
                      <ul className="list-disc pl-5 space-y-1 text-zinc-400">
                        <li>Forme juridique : [Ex: SAS / Auto-entrepreneur]</li>
                        <li>Siège social : [Votre adresse complète]</li>
                        <li>SIRET : [Votre numéro SIRET]</li>
                        <li>Directeur de la publication : ident@aviationonline.fr</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-emerald-500">2. Hébergement</h3>
                      <p>Le site est hébergé par <strong>Google Cloud Platform (GCP)</strong>.</p>
                      <p className="text-zinc-400">Adresse : 8 rue de Londres, 75009 Paris, France.</p>
                    </section>
                    <section>
                    ...
                    <section>
                      <h3 className="text-emerald-500">4. Contact</h3>
                      <p>Pour toute question, vous pouvez nous contacter à l'adresse suivante : <strong>ident@aviationonline.fr</strong></p>
                    </section>
                  </div>
                ) : (
                  <div className="space-y-6">
                    <section>
                      <h3 className="text-emerald-500">Article 1 : Objet</h3>
                      <p>Les présentes Conditions Générales d'Utilisation (CGU) encadrent l'utilisation du service EASA Assist, un assistant conversationnel spécialisé dans la réglementation aérienne européenne.</p>
                    </section>
                    <section>
                      <h3 className="text-emerald-500">Article 2 : Accès au service</h3>
                      <p>L'accès au service est conditionné par la création d'un compte utilisateur. Le service propose :</p>
                      <ul className="list-disc pl-5 space-y-1 text-zinc-400">
                        <li>Une période d'essai gratuite de 3 jours.</li>
                        <li>Un abonnement mensuel de 9,90€ TTC, sans engagement, résiliable à tout moment.</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-emerald-500">Article 3 : Responsabilité (Avertissement IA)</h3>
                      <p className="bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-xl text-emerald-400 italic">
                        EASA Assist utilise une intelligence artificielle pour générer des réponses. Bien que l'outil cite ses sources, les informations fournies le sont à titre indicatif et ne constituent pas un conseil juridique ou opérationnel officiel.
                      </p>
                      <p className="mt-4">L'utilisateur est seul responsable de la vérification des informations auprès des publications officielles de l'EASA (Easy Access Rules) avant toute prise de décision opérationnelle.</p>
                    </section>
                    <section>
                      <h3 className="text-emerald-500">Article 4 : Données personnelles</h3>
                      <p>Conformément au Règlement Général sur la Protection des Données (RGPD), Aviation Online s'engage à protéger la vie privée de ses utilisateurs. Vous disposez d'un droit d'accès, de rectification et de suppression de vos données via votre espace personnel ou par email.</p>
                    </section>
                    <section>
                      <h3 className="text-emerald-500">Article 5 : Droit applicable</h3>
